...
# Embedded file name: pyglet\font\fontconfig.py
"""
...
FcResultMatch, FcResultNoMatch, FcResultTypeMismatch, FcResultNoId, FcResultOutOfMemory = range(5)
FcResult = c_int
...
class FontConfig:
    ...
    def _load_fontconfig_library():
        ...
        fontconfig.FcPatternAddDouble.argtypes = [
...
class FontConfigPattern:
    ...
    def _create(self):
        if not not self._pattern:
            raise AssertionError
        elif not self._fontconfig:
            raise AssertionError
