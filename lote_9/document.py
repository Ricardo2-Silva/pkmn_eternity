...
# Embedded file name: pyglet\text\document.py
...
class UnformattedDocument(AbstractDocument):
    ...
    def get_font(self, position=None, dpi=None):
        ...
        return font.load(font_name, font_size, bold=bold,
          italic=italic,
          stretch=stretch,
          dpi=dpi)
