...
# Embedded file name: pyglet\media\player.py
...
class Player(pyglet.event.EventDispatcher):
    __doc__ = "High-level sound and video player."
    _volume = 1.0
    _min_distance = 1.0
    ...
    def queue(self, source):
        ...
        if isinstance(source, (Source, SourceGroup)):
            ...
            try:
                ...
                raise TypeError("source must be either a Source or an iterable. Received type {0}".format(type(source)))
    ...
    def _create_audio_player(self):
        ...
        for attr in ('volume', 'min_distance', 'max_distance', 'position', 'pitch',
                     'cone_orientation', 'cone_inner_angle', 'cone_outer_angle',
                     'cone_outer_gain'):
    ...
    def _create_texture(self):
        ...
        self._texture = pyglet.image.Texture.create((video_format.width),
          (video_format.height), rectangle=True)
