...
# Embedded file name: pyglet\input\wintab.py
...
class WintabTabletCanvas(TabletCanvas):
    ...
    def __init__(self, device, window, msg_base=wintab.WT_DEFBASE):
        ...
        context_info.lcPktData = wintab.PK_CHANGED | wintab.PK_CURSOR | wintab.PK_BUTTONS | wintab.PK_X | wintab.PK_Y | wintab.PK_Z | wintab.PK_NORMAL_PRESSURE | wintab.PK_TANGENT_PRESSURE | wintab.PK_ORIENTATION
    ...
    def _event_wt_packet(self, msg, wParam, lParam):
        ...
        self.dispatch_event("on_motion", self._current_cursor, x, y, pressure, 0.0, 0.0)
