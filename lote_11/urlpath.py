...
# Embedded file name: twisted\python\urlpath.py
"""
L{URLPath}, a representation of a URL.
"""
from __future__ import division, absolute_import
from twisted.python.compat import nativeString, unicode, urllib_parse as urlparse, urlunquote, urlquote
...
class URLPath(object):
    ...
    def _reconstitute(self):
        ...
        """
        urltext = urlquote((urlparse.urlunsplit((self._scheme, self._netloc,
    ...
    def pathList(self, unquote=False, copy=True):
        ...
        return [
         b''] + [mapper(segment) for segment in segments]
    ...
    def _mod(self, newURL, keepQuery):
        ...
        @return: a new L{URLPath}
        """
        return self._fromURL(newURL.replace(fragment="",
          query=(self._url.query if keepQuery else ())))
