...
# Embedded file name: pyglet\sprite.py
...
class Sprite(event.EventDispatcher):
    __doc__ = "Instance of an on-screen image.\n\n    See the module documentation for usage.\n    "
    _batch = None
    _animation = None
    _frame_index = 0
    _paused = False
    ...
    def __init__(self, img, x=0, y=0, blend_src=GL_SRC_ALPHA, blend_dest=GL_ONE_MINUS_SRC_ALPHA, batch=None, group=None, usage="dynamic", subpixel=False):
        """Create a sprite.
    ...
    def image(self, img):
        ...
        elif isinstance(img, image.Animation):
            self._animation = img
            self._frame_index = 0
    ...
    def _create_vertex_list(self):
        ...
        if self._batch is None:
            self._vertex_list = graphics.vertex_list(4, vertex_format, "c4B", ("t3f", self._texture.tex_coords))
        else:
