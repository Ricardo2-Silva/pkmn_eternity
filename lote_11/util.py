...
# Embedded file name: twisted\python\util.py
...
deprecatedModuleAttribute(Version("Twisted", 15, 5, 0), "Use collections.OrderedDict instead.", "twisted.python.util", "OrderedDict")
...
def getPluginDirs():
    warnings.warn("twisted.python.util.getPluginDirs is deprecated since Twisted 12.2.",
      DeprecationWarning,
      stacklevel=2)
    import twisted
...
def addPluginDir():
    warnings.warn("twisted.python.util.addPluginDir is deprecated since Twisted 12.2.",
      DeprecationWarning,
      stacklevel=2)
...
class SubclassableCStringIO(object):
    ...
    _SubclassableCStringIO__csio = None

    def __init__(self, *a, **kw):
        from cStringIO import StringIO
        self._SubclassableCStringIO__csio = StringIO(*a, **kw)

    def __iter__(self):
        return self._SubclassableCStringIO__csio.__iter__()

    def next(self):
        return self._SubclassableCStringIO__csio.next()

    def close(self):
        return self._SubclassableCStringIO__csio.close()

    def isatty(self):
        return self._SubclassableCStringIO__csio.isatty()

    def seek(self, pos, mode=0):
        return self._SubclassableCStringIO__csio.seek(pos, mode)

    def tell(self):
        return self._SubclassableCStringIO__csio.tell()

    def read(self, n=-1):
        return self._SubclassableCStringIO__csio.read(n)

    def readline(self, length=None):
        return self._SubclassableCStringIO__csio.readline(length)

    def readlines(self, sizehint=0):
        return self._SubclassableCStringIO__csio.readlines(sizehint)

    def truncate(self, size=None):
        return self._SubclassableCStringIO__csio.truncate(size)

    def write(self, s):
        return self._SubclassableCStringIO__csio.write(s)

    def writelines(self, list):
        return self._SubclassableCStringIO__csio.writelines(list)

    def flush(self):
        return self._SubclassableCStringIO__csio.flush()

    def getvalue(self):
        return self._SubclassableCStringIO__csio.getvalue()
...
__all__ = [
 ...
 'untilConcludes', 
 'runWithWarningsSuppressed', '_replaceIf']
if _PY3:
    __notported__ = [
     "SubclassableCStringIO", "makeStatBar"]
    for name in __all__[:]:
