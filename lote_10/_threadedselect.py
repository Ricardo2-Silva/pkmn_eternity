...
# Embedded file name: twisted\internet\_threadedselect.py
"""
...
class ThreadedSelectReactor(posixbase.PosixReactorBase):
    __doc__ = "A threaded select() based reactor - runs on all POSIX platforms and on\n    Win32.\n    "
        ...
        try:
            while 1:
                ...
                if fn is self._doIterationInThread:
                    ...
                    if fn is raiseException:
                        if args[0] is SystemExit:
                            continue
                        fn(*args)
