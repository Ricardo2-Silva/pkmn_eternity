...
# Embedded file name: zope\interface\interface.py
...
class InterfaceBasePy(object):
    __doc__ = "Base class that wants to be replaced with a C base :)\n    "
...
class Specification(SpecificationBase):
    ...
    __bases__ = property((lambda self: self.__dict__.get("__bases__", ())), _Specification__setBases)
...
class InterfaceClass(Element, InterfaceBase, Specification):
    __doc__ = "Prototype (scarecrow) Interfaces Implementation."
    ...
    def names(self, all=False):
        ...
        if not all:
            ...
            r = self._InterfaceClass__attrs.copy()
            for base in self.__bases__:
    ...
    def namesAndDescriptions(self, all=False):
        ...
        if not all:
            ...
            r.update(self._InterfaceClass__attrs)
            return r.items()
    ...
    def direct(self, name):
        return self._InterfaceClass__attrs.get(name)
    ...
    def __cmp(self, other):
        ...
        if other is None:
            ...
            n1 = (
             getattr(self, "__name__", ""), getattr(self, "__module__", ""))
    ...
    def __eq__(self, other):
        c = self._InterfaceClass__cmp(other)
        return c == 0
...
class Attribute(Element):
    __doc__ = "Attribute descriptions\n    "
    interface = None


class Method(Attribute):
    __doc__ = "Method interfaces\n\n    The idea here is that you have objects that describe methods.\n    This provides an opportunity for rich meta-data.\n    "
    positional = required = ()
