...
# Embedded file name: pyglet\text\__init__.py
...
class DocumentDecodeException(Exception):
    __doc__ = "An error occurred decoding document text."
    return


class DocumentDecoder:
    __doc__ = "Abstract document decoder.\n    "
...
class Label(DocumentLabel):
    ...
    def __init__(self, text='', font_name=None, font_size=None, bold=False, italic=False, stretch=False, color=(255, 255, 255, 255), x=0, y=0, width=None, height=None, anchor_x='left', anchor_y='baseline', align='left', multiline=False, dpi=None, batch=None, group=None):
