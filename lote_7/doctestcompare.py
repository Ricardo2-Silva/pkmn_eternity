...
# Embedded file name: lxml\doctestcompare.py
"""
    ...
    def get_parser(self, want, got, optionflags):
        ...
        if NOPARSE_MARKUP & optionflags:
            ...
            if PARSE_HTML & optionflags:
                ...
                pass
            if got.strip().startswith("<html"):
                parser = html_fromstring
            if self._looks_like_markup(want):
                if self._looks_like_markup(got):
