...
from six import binary_type as _binary_type, integer_types, int2byte, indexbytes
...
class _NpnAdvertiseHelper(_CallbackExceptionHelper):
    ...
    def __init__(self, callback):
        ...
        self.callback = _ffi.callback("int (*)(SSL *, const unsigned char **, unsigned int *, void *)", wrapper)
        ...
        def wrapper(ssl, out, outlen, in_, inlen, arg):
            try:
                ...
                if outbytes is NO_OVERLAPPING_PROTOCOLS:
                    ...
                    if not isinstance(outbytes, _binary_type):
...
def _warn_npn():
    warnings.warn("NPN is deprecated. Protocols should switch to using ALPN.", DeprecationWarning,
      stacklevel=3)
...
class Context(object):
    ...
    def set_default_verify_paths(self):
        ...
        *   manylinux1 cryptography wheels will work on most common Linux
        ...
        if not self._check_env_vars_set(dir_env_var, file_env_var):
            ...
            if default_dir == _CRYPTOGRAPHY_MANYLINUX1_CA_DIR:
                if default_file == _CRYPTOGRAPHY_MANYLINUX1_CA_FILE:
    ...
    def set_npn_advertise_callback(self, callback):
        ...
        _lib.SSL_CTX_set_next_protos_advertised_cb(self._context, self._npn_advertise_callback, _ffi.NULL)
    ...
    def set_npn_select_callback(self, callback):
        ...
        _lib.SSL_CTX_set_next_proto_select_cb(self._context, self._npn_select_callback, _ffi.NULL)
...
class Connection(object):
    ...
    def _raise_ssl_error(self, ssl, result):
        ...
        elif self._context._npn_advertise_helper is not None:
            self._context._npn_advertise_helper.raise_if_problem()
        elif self._context._npn_select_helper is not None:
