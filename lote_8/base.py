...
# Embedded file name: pyglet\app\base.py
import sys, queue, platform, threading
...
class PlatformEventLoop:
    __doc__ = " Abstract class, implementation depends on platform.\n    \n    .. versionadded:: 1.2\n    "
