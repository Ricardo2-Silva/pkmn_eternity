...
# Embedded file name: pyasn1_modules\rfc2459.py
...
class DSAPrivateKey(univ.Sequence):
    __doc__ = "PKIX compliant DSA private key structure"
...
class E163_4_address(univ.Sequence):
    componentType = namedtype.NamedTypes(namedtype.NamedType("number", char.NumericString().subtype(subtypeSpec=(constraint.ValueSizeConstraint(1, ub_e163_4_number_length)),
      explicitTag=(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)))), namedtype.OptionalNamedType("sub-address", char.NumericString().subtype(subtypeSpec=(constraint.ValueSizeConstraint(1, ub_e163_4_sub_address_length)),
...
class TeletexPersonalName(univ.Set):
    componentType = namedtype.NamedTypes(namedtype.NamedType("surname", char.TeletexString().subtype(subtypeSpec=(constraint.ValueSizeConstraint(1, ub_surname_length)),
      explicitTag=(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)))), namedtype.OptionalNamedType("given-name", char.TeletexString().subtype(subtypeSpec=(constraint.ValueSizeConstraint(1, ub_given_name_length)),
      explicitTag=(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)))), namedtype.OptionalNamedType("initials", char.TeletexString().subtype(subtypeSpec=(constraint.ValueSizeConstraint(1, ub_initials_length)),
      explicitTag=(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2)))), namedtype.OptionalNamedType("generation-qualifier", char.TeletexString().subtype(subtypeSpec=(constraint.ValueSizeConstraint(1, ub_generation_qualifier_length)),
...
class ExtensionAttribute(univ.Sequence):
    componentType = namedtype.NamedTypes(namedtype.NamedType("extension-attribute-type", univ.Integer().subtype(subtypeSpec=(constraint.ValueSizeConstraint(0, ub_extension_attributes)),
      explicitTag=(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)))), namedtype.NamedType("extension-attribute-value", univ.Any().subtype(explicitTag=(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)))))
...
class PersonalName(univ.Set):
    componentType = namedtype.NamedTypes(namedtype.NamedType("surname", char.PrintableString().subtype(subtypeSpec=(constraint.ValueSizeConstraint(1, ub_surname_length)),
      explicitTag=(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)))), namedtype.OptionalNamedType("given-name", char.PrintableString().subtype(subtypeSpec=(constraint.ValueSizeConstraint(1, ub_given_name_length)),
      explicitTag=(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)))), namedtype.OptionalNamedType("initials", char.PrintableString().subtype(subtypeSpec=(constraint.ValueSizeConstraint(1, ub_initials_length)),
      explicitTag=(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2)))), namedtype.OptionalNamedType("generation-qualifier", char.PrintableString().subtype(subtypeSpec=(constraint.ValueSizeConstraint(1, ub_generation_qualifier_length)),
      explicitTag=(tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3)))))
...
_certificateAttributesMapUpdate = {id_at_name: (X520name()), 
...
_certificateExtensionsMapUpdate = {id_ce_authorityKeyIdentifier: (AuthorityKeyIdentifier()), 
