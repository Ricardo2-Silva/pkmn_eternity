...
class _HMACContext(object):
    ...
    def __init__(self, backend, key, algorithm, ctx=None):
        ...
        if ctx is None:
            ...
            ctx = self._backend._ffi.gc(ctx, self._backend._lib.Cryptography_HMAC_CTX_free)
    ...
    def copy(self):
        ...
        copied_ctx = self._backend._ffi.gc(copied_ctx, self._backend._lib.Cryptography_HMAC_CTX_free)
