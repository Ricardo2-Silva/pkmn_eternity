...
__all__ = [
 ...
 'DefragResultBytes', 
 'ParseResultBytes', 'SplitResultBytes']
uses_relative = [
...
def urlsplitParse error at or near `POP_JUMP_IF_TRUE' instruction at offset 478_480
    ...
    if not string:
        ...
        if isinstance(string, str):
            ...
            if _hextobyte is None:
                _hextobyte = {(a + b).encode(): bytes([int(a + b, 16)]) for b in _hexdig}
        for item in bits[1:]:
            try:
