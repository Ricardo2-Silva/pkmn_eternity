...
# Embedded file name: pyglet\text\caret.py
...
class Caret:
    ...
    def _blink(self, dt):
        ...
        elif self._visible and self._active and self._blink_visible:
            alpha = 255
        else:
            alpha = 0
        ...
        if motion == key.MOTION_BACKSPACE:
            if self.mark is not None:
                ...
                if motion == key.MOTION_LEFT:
                    ...
                    self.position = m or len(self._layout.document.text)
                else:
