...
def _verify_openssl_version(lib):
    if lib.CRYPTOGRAPHY_OPENSSL_LESS_THAN_110:
        if not lib.CRYPTOGRAPHY_IS_LIBRESSL:
            warnings.warn("OpenSSL version 1.0.2 is no longer supported by the OpenSSL project, please upgrade. The next version of cryptography will drop support for it.", utils.CryptographyDeprecationWarning)
