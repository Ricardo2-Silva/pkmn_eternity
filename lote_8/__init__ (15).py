...
# Embedded file name: pyglet\libs\win32\__init__.py
import struct, pyglet
...
_kernel32.SetWaitableTimer.argtypes = [HANDLE, POINTER(LARGE_INTEGER), LONG, LPVOID, LPVOID, BOOL]
...
_user32.MapWindowPoints.argtypes = [HWND, HWND, c_void_p, UINT]
...
_user32.ReleaseDC.restype = c_int32
...
_ole32.CreateStreamOnHGlobal.argtypes = [
 HGLOBAL, BOOL, LPSTREAM]
