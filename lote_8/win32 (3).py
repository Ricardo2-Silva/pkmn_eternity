...
# Embedded file name: pyglet\gl\win32.py
...
class Win32Config(Config):
    ...
    def match(self, canvas):
        ...
        if gl_info.have_context():
            if wgl_info.have_extension("WGL_ARB_pixel_format"):
...
class Win32CanvasConfigARB(CanvasConfig):
    attribute_ids = {'double_buffer':wglext_arb.WGL_DOUBLE_BUFFER_ARB, 
