...
import sys, threading, array, queue, time
...
class BaseManager(object):
    ...
    def __enter__(self):
        if self._state.value == State.INITIAL:
            self.start()
        elif not self._state.value == State.STARTED:
...
BaseListProxy = MakeProxyType("BaseListProxy", ('__add__', '__contains__', '__delitem__',
                                                '__getitem__', '__len__', '__mul__',
...
DictProxy = MakeProxyType("DictProxy", ('__contains__', '__delitem__', '__getitem__',
                                        '__iter__', '__len__', '__setitem__', 'clear',
                                        'copy', 'get', 'has_key', 'items', 'keys',
...
BasePoolProxy = MakeProxyType("PoolProxy", ('apply', 'apply_async', 'close', 'imap',
                                            'imap_unordered', 'join', 'map', 'map_async',
                                            'starmap', 'starmap_async', 'terminate'))
