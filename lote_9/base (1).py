...
# Embedded file name: pyglet\media\devices\base.py
...
class AudioDevice:
    ...
    def __repr__(self):
        return "{}(name={}, state={}, flow={})".format(self.__class__.__name__, self.name, self._platform_state[self.state], self._platform_flow[self.flow])
