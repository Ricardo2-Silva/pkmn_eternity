...
class QueueEmpty(Exception):
    __doc__ = "Exception raised when Queue.get_nowait() is called on a Queue object\n    which is empty.\n    "
    return


class QueueFull(Exception):
    __doc__ = "Exception raised when the Queue.put_nowait() method is called on a Queue\n    object which is full.\n    "
    return
