...
# Embedded file name: pyglet\media\drivers\directsound\interface.py
"""
...
class DirectSoundBufferFactory:
    ...
    def create_buffer(self, audio_format):
        ...
        return DirectSoundBuffer(self._create_buffer(buffer_desc), audio_format, buffer_size)

    def create_primary_buffer(self):
        return DirectSoundBuffer(self._create_buffer(self._create_primary_buffer_desc()), None, 0)
...
class DirectSoundBuffer:
    ...
    def lock(self, write_cursor, write_size):
        ...
        _check(self._native_buffer.Lock(write_cursor, write_size, ctypes.byref(pointer.audio_ptr_1), pointer.audio_length_1, ctypes.byref(pointer.audio_ptr_2), pointer.audio_length_2, 0))
        return pointer
