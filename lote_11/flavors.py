...
# Embedded file name: twisted\spread\flavors.py
"""
...
from .jelly import setUnjellyableForClass, setUnjellyableForClassTree, setUnjellyableFactoryForClass, unjellyableRegistry, Jellyable, Unjellyable, setInstanceState, getInstanceState, _createBlank
...
class NoSuchMethod(AttributeError):
    __doc__ = "Raised if there is no such remote method"


class IPBRoot(Interface):
    __doc__ = "Factory for root Referenceable objects for PB servers."
...
class RemoteCacheMethod:
    __doc__ = "A method on a reference to a L{RemoteCache}.\n    "
