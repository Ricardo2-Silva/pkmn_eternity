...
# Embedded file name: twisted\python\reflect.py
"""
Standardized versions of various cool and/or strange things that you can do
with Python's reflection capabilities.
"""
from __future__ import division, absolute_import, print_function
import sys, types, os, pickle, weakref, re, traceback
...
if not _PY3:
    ...
    def objgrep(start, goal, eq=isLike, path="", paths=None, seen=None, showUnknowns=0, maxDepth=None):
        ...
        elif not isinstance(start, (compat.StringType,
         int, types.FunctionType,
         types.BuiltinMethodType, RegexType, float,
         type(None), compat.FileType)):
            pass
        if type(start).__name__ in ('wrapper_descriptor', 'method_descriptor', 'member_descriptor',
                                    'getset_descriptor'):
            pass
        else:
            if showUnknowns:
...
__all__ = [
 ...
 'safe_repr', 
 'safe_str', 'prefixedMethodNames', 'addMethodNamesToDict', 
 'prefixedMethods', 
 'accumulateMethods', 'fullFuncName', 'qual', 'getClass', 
 'accumulateClassDict', 
 'accumulateClassList', 'isSame', 'isLike', 
 'modgrep', 'isOfType', 'findInstances', 
 'objgrep', 'filenameToModuleName', 
 'fullyQualifiedName']
if _PY3:
