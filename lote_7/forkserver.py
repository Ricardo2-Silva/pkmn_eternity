...
import errno, os, selectors, signal, socket, struct, sys, threading
...
MAXFDS_TO_SEND = 256
UNSIGNED_STRUCT = struct.Struct("Q")
...
def main(listener_fd, alive_r, preload, main_path=None, sys_path=None):
    ...
    util._close_stdin()
    handlers = {(signal.SIGCHLD): (signal.SIG_IGN), 
...
def _serve_one(s, listener, alive_r, handlers):
    ...
    child_r, child_w, _forkserver._forkserver_alive_fd, stfd, *_forkserver._inherited_fds = fds
