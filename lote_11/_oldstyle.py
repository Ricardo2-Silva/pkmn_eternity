...
# Embedded file name: twisted\python\_oldstyle.py
"""
...
def _ensureOldClass(cls):
    ...
    if type(cls) is not types.ClassType:
        ...
        raise ValueError("twisted.python._oldstyle._oldStyle is being used to decorate a new-style class ({cls}). This should only be used to decorate old-style classes.".format(cls=(fullyQualifiedName(cls))))
    return cls
