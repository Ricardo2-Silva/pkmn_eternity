...
# Embedded file name: pyglet\gui\widgets.py
...
class TextEntry(WidgetBase):
    __doc__ = "Instance of a text entry widget.\n\n    Allows the user to enter and submit text.\n    "

    def __init__(self, text, x, y, width, color=(255, 255, 255, 255), text_color=(0, 0, 0, 255), caret_color=(0, 0, 0), batch=None, group=None):
