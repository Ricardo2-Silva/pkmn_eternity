...
# Embedded file name: twisted\internet\win32eventreactor.py
"""
...
try:
    ...
    import warnings
    warnings.warn("Reliable disconnection notification requires pywin32 215 or later",
...
class _ThreadedWin32EventsMixin(object):
    ...
    def _makeHelperReactor(self):
        ...
        self._reactorThread = Thread(target=(self._reactor.run),
          args=(False, ))
