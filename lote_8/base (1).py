...
# Embedded file name: pyglet\canvas\base.py
...
class Display:
    __doc__ = "A display device supporting one or more screens.\n    \n    .. versionadded:: 1.2\n    "
    name = None
    x_screen = None
