...
# Embedded file name: twisted\python\filepath.py
"""
...
class FilePath(AbstractFilePath):
    ...
    def makedirs(self, ignoreExistingDirectory=False):
        ...
        try:
            ...
            if not (e.errno == errno.EEXIST and ignoreExistingDirectory and self.isdir()):
                raise
    ...
    def copyTo(self, destination, followLinks=True):
        ...
        if self.islink():
            ...
            if self.isdir():
                ...
                with destination.open("w") as writefile:
                    with self.open() as readfile:
                        while 1:
