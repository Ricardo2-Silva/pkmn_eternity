...
# Embedded file name: pyglet\media\codecs\ffmpeg_lib\libavcodec.py
...
AVCodecContext._fields_ = [
 ...
 (
  "draw_horiz_band",
  CFUNCTYPE(None, POINTER(AVCodecContext), POINTER(AVFrame), c_int * 8, c_int, c_int, c_int)),
 (
 ...
 (
  "rtp_callback",
  CFUNCTYPE(None, POINTER(AVCodecContext), c_void_p, c_int, c_int)),
 (
 ...
 (
  "execute",
  CFUNCTYPE(c_int, POINTER(AVCodecContext), CFUNCTYPE(c_int, POINTER(AVCodecContext), c_void_p), c_void_p, c_int, c_int, c_int)),
 (
  "execute2",
  CFUNCTYPE(c_int, POINTER(AVCodecContext), CFUNCTYPE(c_int, POINTER(AVCodecContext), c_void_p, c_int, c_int), c_void_p, c_int, c_int)),
 (
  "nsse_weight", c_int),
 (
  "profile", c_int),
...
AV_CODEC_ID_VP8 = 139
AV_CODEC_ID_VP9 = 167
avcodec.av_packet_unref.argtypes = [
 POINTER(AVPacket)]
