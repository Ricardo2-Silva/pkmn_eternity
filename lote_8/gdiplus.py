...
# Embedded file name: pyglet\image\codecs\gdiplus.py
...
gdiplus.GdipCreateSolidFill.argtypes = [c_int, c_void_p]
...
gdiplus.GdipGraphicsClear.argtypes = [c_void_p, c_int]
...
gdiplus.GdipMeasureString.argtypes = [c_void_p, c_wchar_p, c_int, c_void_p, c_void_p, c_void_p, c_void_p, INT_PTR, 
 INT_PTR]
