...
__all__ = [
 ...
 'FloatOperation', 
 'DivisionImpossible', 
 'InvalidContext', 'ConversionSyntax', 'DivisionUndefined', 
 'ROUND_DOWN', 
 'ROUND_HALF_UP', 'ROUND_HALF_EVEN', 'ROUND_CEILING', 
...
def _parse_format_specifier(format_spec, _localeconv=None):
    ...
    elif format_dict["thousands_sep"] is None:
